...
# Kiểm tra thư mục site trong workspace
...
# Đồng bộ site/ từ workspace sang SITE_DIR
rsync -av --delete "$SRC_PATH/" "$SITE_DIR/" | tee -a "$LOG_FILE"

# Chèn timestamp & commit vào index.html 
